...
<div class="card mb-4">
    <div class="row ms-2 me-3">
        <div class="col-md-6" style="margin:1%">
            <a class="btn btn-primary" href="architect_add.php" style="margin-right:15px;"><i class="bx bx-plus"></i>
                Add
                Architect</a>
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    while ($city = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a
                                    href="javascript:editdata('<?php echo $city["id"] ?>','<?php echo $city["contact"] ?>','<?php echo base64_encode($city["name"]) ?>','<?php echo $city["status"] ?>');"><i
                                        class="bx bx-edit-alt me-1"></i> </a>
                                <a
                                    href="javascript:deletedata('<?php echo $city["id"] ?>','<?php echo base64_encode($city["name"]) ?>');"><i
                                        class="bx bx-trash me-1"></i> </a>
                                <a
                                    href="javascript:viewdata('<?php echo $city["id"] ?>','<?php echo $city["contact"] ?>','<?php echo base64_encode($city["name"]) ?>','<?php echo $city["status"] ?>');">View</a>
                            </td>
                        </tr>
                        <?php
                        $i++;
