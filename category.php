...
<div class="card mb-4">
    <div class="row ms-2 me-3">
        <div class="col-md-6" style="margin:1%">
            <a class="btn btn-primary" href="category_add.php" style="margin-right:15px;"><i class="bx bx-plus"></i> Add
                Category</a>
                    ...
                    while ($city = mysqli_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a
                                    href="javascript:viewdata('<?php echo $city["id"] ?>','<?php echo base64_encode($city["name"]) ?>','<?php echo $city["status"] ?>');">View</a>
                            </td>
                        </tr>
                        <?php
                        $i++;
