...
method:post
*/
$app->post('/update_weight_2', function () use ($app) {
    ...
    $jobdata="";
     // calculate charges
    echo "charges=".$get_amount=$db->get_amount($weight,$mail_type);

   // check if discount is available or not 
    echo "disc=".$get_discount=$db->get_discount($coupon_id,$get_amount,$delivery_charge);
    if($get_discount==1)
    {
